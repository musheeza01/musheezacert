...
<p style={{ margin: " -50px 0px 0px 400px" }}> Moving the switch to the left will play the tune 'Bruno' from the movie Encanto</p>
...
<img style={{  margin: "0px 0px 0px 0px", clear: "right", float: "left", height: "500px", width: "300px"}} src="/images/infraredreceived.png"/>
